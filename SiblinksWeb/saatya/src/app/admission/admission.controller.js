...
brotControllers.controller('AdmissionCtrl', ['$scope', '$rootScope', '$log', '$location', '$http', '$timeout', 'AdmissionService', 'StudentService',
	...
	AdmissionService.getVideoTuttorialAdmission($scope.idAdmission).then(function(data) {
	...
	AdmissionService.getArticleAdmission($scope.idAdmission).then(function(data) {
